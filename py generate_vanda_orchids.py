...
PROMPT = (
    "Vanda orchid stem with multiple large blooms, close-up studio photography, "
    "pure solid white background, vibrant colorful petals filling the frame, "
    "sharp crisp focus, professional botanical photography, "
    "high contrast, rich saturated colors, centered composition"
)

NEGATIVE_PROMPT = (
    "blurry, out of focus, small flowers, distant, washed out, overexposed, "
    "pale, faded, watermark, text, grey background, dark background, "
    "shadows, low quality, multiple stems, landscape"
)
